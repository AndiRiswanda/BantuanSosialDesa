      ...
      <main className="flex-1 px-4 sm:px-6 lg:px-20 py-6 lg:py-10">
        ...
        <div className="mb-5">
          <div className="mx-auto bg-white border border-green-300 rounded-xl shadow-sm p-4 sm:p-5">
            <h1 className="text-center text-[#0B2B5E] font-semibold text-lg sm:text-xl">Buat Jadwal dan Edit Penyaluran</h1>
            <p className="text-center text-xs text-slate-600 mt-1">
              Anda dapat membagi penyaluran menjadi beberapa tahap. Setiap tahap bisa dijadwalkan di waktu dan lokasi berbeda dengan penerima yang berbeda.
            </p>
              ...
              <div className="grid sm:grid-cols-2 gap-3">
                ...
                <div className="rounded-lg border border-slate-200 bg-slate-50 p-3 text-sm">
                  ...
                  <textarea
                    ...
                    rows={3}
                    value={meta.criteria}
                    onChange={(e) => setMeta((m) => ({ ...m, criteria: e.target.value }))}
                  />
                </div>
              </div>
