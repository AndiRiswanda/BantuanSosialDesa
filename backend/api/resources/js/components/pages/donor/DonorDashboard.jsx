...
import { CircleDollarSign, Users, HandHeart } from "lucide-react";
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-8">
            ...
            <div className="bg-slate-100 rounded-xl border-2 border-[#3B82F6]/50 px-6 py-6 shadow-sm flex flex-col items-center">
              <div className="flex items-center gap-3 text-[#0B2B5E]">
                ...
                <div className="text-lg md:text-xl font-bold">Rp. 1.567.000.000,-</div>
              </div>
            ...
            <div className="bg-slate-100 rounded-xl border-2 border-[#3B82F6]/50 px-6 py-6 shadow-sm flex flex-col items-center">
              <div className="flex items-center gap-3 text-[#0B2B5E]">
                ...
                <div className="text-lg md:text-xl font-bold">712</div>
              </div>
