...
import { AlertTriangle, FileDown, FileText, Image as ImageIcon, LogOut, Pencil, Receipt, ShieldCheck, UserCircle2 } from "lucide-react";
      ...
      <main className="flex-1 px-4 sm:px-6 lg:px-20 py-6 lg:py-10">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-[260px,1fr] gap-4">
          ...
          <aside className="space-y-3 self-start">
            ...
            <SidebarItem active={false} onClick={() => navigate('/penerima/profil/edit')} icon={Pencil}>Edit Profil</SidebarItem>
