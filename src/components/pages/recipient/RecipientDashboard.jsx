        ...
        <div>
          ...
          <div className="rounded-lg border border-emerald-200 bg-emerald-50 p-3">
            <div className="grid grid-cols-2 gap-2 text-sm">
              ...
              <div>
                <div className="text-xs text-slate-600">Jumlah</div>
                <div className="font-medium">Rp {latest_transaction.amount?.toLocaleString('id-ID')}</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <section className="bg-white/80 border border-blue-200 rounded-lg shadow-sm px-4 py-4 sm:px-6 sm:py-5 mb-6">
          ...
          <div className="mt-3 grid grid-cols-2 md:grid-cols-4 gap-3">
            <div className="bg-white rounded-lg p-3 border border-slate-200">
              <div className="text-xs text-slate-600">Total Program</div>
              <div className="text-xl font-bold text-slate-900">{stats.total_programs}</div>
            </div>
            <div className="bg-emerald-50 rounded-lg p-3 border border-emerald-200">
              <div className="text-xs text-emerald-700">Disetujui</div>
              <div className="text-xl font-bold text-emerald-900">{stats.approved_programs}</div>
            </div>
            <div className="bg-amber-50 rounded-lg p-3 border border-amber-200">
              <div className="text-xs text-amber-700">Menunggu</div>
              <div className="text-xl font-bold text-amber-900">{stats.pending_programs}</div>
            </div>
            <div className="bg-blue-50 rounded-lg p-3 border border-blue-200">
              <div className="text-xs text-blue-700">Selesai</div>
              <div className="text-xl font-bold text-blue-900">{stats.completed_programs}</div>
            </div>
          </div>
        </section>
